...
var author$project$Main$Tangram = {$: 'Tangram'};
var author$project$Main$rgb = F3(
	function (r, g, b) {
		return {alpha: 1, blue: b, green: g, red: r};
	});
var author$project$Main$palette = {
	blue: A3(author$project$Main$rgb, 96, 181, 204),
	green: A3(author$project$Main$rgb, 127, 209, 59),
	lavender: A3(author$project$Main$rgb, 90, 99, 120),
	orange: A3(author$project$Main$rgb, 240, 173, 0)
};
...
var author$project$Main$tangram = _List_fromArray(
	[
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(0, 20),
					_Utils_Tuple2(280, 300),
					_Utils_Tuple2(0, 580)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.lavender)
		]),
		_List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			_List_fromArray(
				[
					_Utils_Tuple2(20, 600),
					_Utils_Tuple2(300, 320),
					_Utils_Tuple2(580, 600)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.blue)
		]),
		_List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
		...
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(20, 0),
					_Utils_Tuple2(280, 0),
					_Utils_Tuple2(402, 122),
					_Utils_Tuple2(142, 122)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.green)
		]),
		_List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			_List_fromArray(
				[
					_Utils_Tuple2(170, 150),
					_Utils_Tuple2(430, 150),
					_Utils_Tuple2(300, 280)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.orange)
		]),
		_List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			_List_fromArray(
				[
					_Utils_Tuple2(320, 300),
					_Utils_Tuple2(450, 170),
					_Utils_Tuple2(580, 300),
					_Utils_Tuple2(450, 430)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.green)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(470, 450),
					_Utils_Tuple2(600, 320),
					_Utils_Tuple2(600, 580)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.orange)
		])
	]);
...
var author$project$Main$init = _Utils_Tuple2(
	{
		currentShape: author$project$Main$Tangram,
		index: 1,
		styles: A2(elm$core$List$map, mdgriffith$elm_style_animation$Animation$style, author$project$Main$tangram)
	},
	elm$core$Platform$Cmd$none);
var author$project$Main$Constellation = {$: 'Constellation'};
var author$project$Main$corvus = _List_fromArray(
	[
		_List_fromArray(
		[
			mdgriffith$elm_style_animation$Animation$points(
			_List_fromArray(
				[
					_Utils_Tuple2(0, 17.316),
					_Utils_Tuple2(99.681, 49.061),
					_Utils_Tuple2(134.186, 0)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.green)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(93.5, 241.745),
					_Utils_Tuple2(203.465, 344.538),
					_Utils_Tuple2(260.087, 357.275),
					_Utils_Tuple2(172.46, 204.694)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.orange)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(139.322, 4.397),
					_Utils_Tuple2(104.295, 54.201),
					_Utils_Tuple2(91.327, 235.316),
					_Utils_Tuple2(170.114, 198.346)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.blue)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(245.818, 131.749),
					_Utils_Tuple2(332.058, 294.554),
					_Utils_Tuple2(510.304, 392.559),
					_Utils_Tuple2(405.588, 256.698)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.lavender)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(600, 450),
					_Utils_Tuple2(330.196, 301.227),
					_Utils_Tuple2(272.465, 361.239),
					_Utils_Tuple2(456.368, 450)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.blue)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(325.448, 296.448),
					_Utils_Tuple2(234.943, 125.59),
					_Utils_Tuple2(177.862, 200.588),
					_Utils_Tuple2(267.505, 356.68)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.green)
		]),
		_List_fromArray(
		[
			...
			_List_fromArray(
				[
					_Utils_Tuple2(231.791, 118.619),
					_Utils_Tuple2(212.372, 42.825),
					_Utils_Tuple2(145.802, 2.333),
					_Utils_Tuple2(175.918, 192.027)
				])),
			mdgriffith$elm_style_animation$Animation$fill(author$project$Main$palette.orange)
		])
	]);
...
var author$project$Main$update = F2(
	function (action, model) {
		if (action.$ === 'EverybodySwitch') {
			var wrappedIndex = (_Utils_cmp(
				elm$core$List$length(model.styles),
				model.index) < 0) ? (model.index - elm$core$List$length(model.styles)) : model.index;
			var _n1 = function () {
				var _n2 = model.currentShape;
				if (_n2.$ === 'Constellation') {
					return _Utils_Tuple2(author$project$Main$tangram, author$project$Main$Tangram);
				} else {
					return _Utils_Tuple2(author$project$Main$corvus, author$project$Main$Constellation);
				}
			}();
			var newStyleList = _n1.a;
			var newShape = _n1.b;
			var newStyles = _Utils_ap(
				A2(elm$core$List$drop, wrappedIndex, newStyleList),
				A2(elm$core$List$take, wrappedIndex, newStyleList));
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						styles: A4(
							elm$core$List$map3,
							F3(
								function (i, style, newStyle) {
									return A2(
										mdgriffith$elm_style_animation$Animation$interrupt,
										_List_fromArray(
											[
												mdgriffith$elm_style_animation$Animation$wait(
												elm$time$Time$millisToPosix(i * 50)),
												mdgriffith$elm_style_animation$Animation$to(newStyle)
											]),
										style);
								}),
							A2(
...
var author$project$Main$EverybodySwitch = {$: 'EverybodySwitch'};
...
var author$project$Main$view = function (model) {
	return A2(
		...
		_List_fromArray(
			[
				elm$html$Html$Events$onClick(author$project$Main$EverybodySwitch),
				A2(elm$html$Html$Attributes$style, 'margin', '200px auto'),
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$svg$Svg$text('Click to morph!')
					])),
				A2(
				elm$svg$Svg$svg,
				_List_fromArray(
					...
					[
						...
						A2(
							...
							function (poly) {
								return A2(
									elm$svg$Svg$polygon,
									mdgriffith$elm_style_animation$Animation$render(poly),
									_List_Nil);
							},
							model.styles))
					]))
...
var author$project$Main$main = elm$browser$Browser$element(
	{
		...
		subscriptions: function (model) {
			return A2(mdgriffith$elm_style_animation$Animation$subscription, author$project$Main$Animate, model.styles);
		},
